...
export const settingsRouter = router({
  ...
  updateThemePreference: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      if (!result.ok) {
        throw mapSettingsThemePreferenceErrorToTRPC({
