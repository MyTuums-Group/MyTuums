...
export function mapGameAccessErrorToRest(error: GameAccessError) {
  return toRestError(mapGameAccessErrorToTransport(error))
}

export function mapFavoriteGameErrorToRest(error: FavoriteGameError) {
  return toRestError(mapFavoriteGameErrorToTransport(error))
}
