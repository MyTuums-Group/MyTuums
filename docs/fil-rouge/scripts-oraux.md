...
| --- | --- | --- |
| Introduction, sujet libre, besoin | ElCabrii | Poser le contexte du projet fil rouge et relier au PDF source des attendus. |
...
| 5:00 - 6:30 | "Nous avons decoupe le travail en issues GitHub et suivi le projet dans Tasks. Les livrables du projet fil rouge sont separes dans `docs/fil-rouge/`, pour ne pas confondre ce dossier et le portefeuille RNCP." |
...
| Temps | Partie | Script |
| --- | --- | --- |
| 0:00 - 1:30 | Introduction | "Nous presentons MyTuums, notre sujet libre pour le projet fil rouge. L'objectif n'est pas de copier Smart Cafe, mais de demontrer les memes competences sur un produit coherent : une plateforme sociale pour joueurs." |
...
| 5:00 - 8:00 | Demo web | "Nous montrons le parcours utilisateur : login, onboarding, feed, creation de post, recherche, interaction et signalement. Chaque etape correspond a une ligne de la matrice du projet fil rouge." |
...
| 19:15 - 20:00 | Conclusion | "MyTuums prouve un produit coherent, une architecture maintenable et une demarche projet defendable. Le dossier relie chaque attendu du projet fil rouge a une preuve concrete." |
...
| Deck pre-final prepare | Partiel | [Diaporama fil rouge](diaporama-fil-rouge.md), à exporter manuellement. |
