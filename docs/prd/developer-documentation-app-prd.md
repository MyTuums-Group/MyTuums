...
24. As a developer, I do not want transient implementation plans exposed in the docs app, so that completed or obsolete plans do not become canonical documentation.
...
- Inclusion of transient implementation plans.
